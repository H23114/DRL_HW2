...
若要將此專案 push 到你的 GitHub repository `https://github.com/H23114/DRL_HW2.git`，可在專案目錄執行：

```powershell
git init
git branch -M main
git remote add origin https://github.com/H23114/DRL_HW2.git
git add .
git commit -m "Submit DRL HW2 final project"
git push -u origin main
```

若該 repository 已存在且本機也已是 git repo，則只需要：

```powershell
git add .
git commit -m "Update DRL HW2 final submission"
git push
```
